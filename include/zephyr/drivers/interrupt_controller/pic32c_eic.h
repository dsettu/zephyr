...
#ifndef ZEPHYR_DRIVERS_INTERRUPT_CONTROLLER_INTC_PIC32C_EIC_H_
#define ZEPHYR_DRIVERS_INTERRUPT_CONTROLLER_INTC_PIC32C_EIC_H_

#include <zephyr/types.h>

/* callback for EIC interrupt */
typedef void (*pic32c_eic_callback_t)(uint32_t pins, void *data);

/**
 * @brief EIC trigger condition
 */
enum pic32c_eic_trigger {
	/* Rising edge */
	PIC32C_EIC_RISING,
	/* Falling edge */
	PIC32C_EIC_FALLING,
...
#endif /* ZEPHYR_DRIVERS_INTERRUPT_CONTROLLER_INTC_PIC32C_EIC_H_ */
