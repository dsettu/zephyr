 ...
 */
#define SOC_DT_INST_DMA_CELL(n, name, cell)		\
	COND_CODE_1(DT_INST_NODE_HAS_PROP(n, dmas),		\
		    (DT_INST_DMAS_CELL_BY_NAME(n, name, cell)),	\
		    (0xff))
#define SOC_DT_INST_DMA_TRIGSRC(n, name) \
	SOC_DT_INST_DMA_CELL(n, name, trigsrc)
#define SOC_DT_INST_DMA_CHANNEL(n, name) \
	SOC_DT_INST_DMA_CELL(n, name, channel)
#define SOC_DT_INST_DMA_CTLR(n, name)			\
	COND_CODE_1(DT_INST_NODE_HAS_PROP(n, dmas),		\
