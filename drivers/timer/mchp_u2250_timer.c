...
#define DT_DRV_COMPAT microchip_rtc_u2250_timer
...
#ifdef MCLK
#define RTC_CLOCK_HW_CYCLES_PER_SEC SOC_OSC32K_FREQ_HZ
#else
#define RTC_CLOCK_HW_CYCLES_PER_SEC SOC_GCLK0_FREQ_HZ
#endif
