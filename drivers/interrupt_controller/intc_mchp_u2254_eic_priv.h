...
#ifndef ZEPHYR_DRIVERS_INTERRUPT_CONTROLLER_INTC_PIC32C_EIC_PRIV_H_
#define ZEPHYR_DRIVERS_INTERRUPT_CONTROLLER_INTC_PIC32C_EIC_PRIV_H_
 ...
 */
static const uint8_t pic32c_eic_channels[PORT_GROUPS][32] = {
#if PORT_GROUPS >= 1
{
...
static inline int pic32c_eic_map_to_line(int port, int pin)
{
	uint8_t ch = pic32c_eic_channels[port][pin];
...
#endif /* ZEPHYR_DRIVERS_INTERRUPT_CONTROLLER_INTC_PIC32C_EIC_PRIV_H_ */
